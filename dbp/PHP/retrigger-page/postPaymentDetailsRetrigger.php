<?php   
	...
	$TYPEFEE 	   = $_POST['TYPEFEE'];
 	$transDateTime = $_POST['TRANS_DATE_TIME'];
	$PROVIDER      = "DBP";   
	$TOKEN_ID 	   = TOKEN_ID;
	...
	//Get Payment Details
	$gatewayLink = $GATEWAY_LINK."?refnum=".$OPTN."&amount=".$AMOUNT."&transactiondate=".$transDateTime."&transactionid=".$TRN."&type=".$TYPEFEE."&provider=".$PROVIDER."&tokenid=".$TOKEN_ID."&DBP_TOKEN_ID=".$DBP_TOKEN_ID; 
