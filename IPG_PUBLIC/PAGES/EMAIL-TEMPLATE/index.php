		...
		if(!$checkDatabase){  
			...
			if($_SESSION['IPG_PUBLIC']['TRANSACTIONS']->pm_code == 'UFP'){
				...
				$transactionHDR = $dbEnterprise->rawQuery("
					...
					SELECT TRN, MERCHANT_CODE, MERCHANT_REF_NUM, SUCCESS_RETURN_URL, FAILED_RETURN_URL, REQUESTOR_NAME, REQUESTOR_EMAIL_ADDRESS, REQUESTOR_MOBILE_NO, PM_CODE, PE_CODE, '".$convenienceFee."','".$ipgFee."','".$cc1p."','".$cc2p."','".$jv_code."', '".$partnerCode."', '3', '".$timeStamp."', CREATED_BY
