 			...
 			<ul class="productList p0 mt30 ">
				<li class="customRow mt20">
					<div class="col-sm-3 p0"> 
						<a class="addToCart" product-id="2" product-name="ASUS Zenbook Pro 14" product-price="20.00">
				...
				<li class="customRow mt20">
					<div class="col-sm-3 p0">
						<a class="addToCart" product-id="2" product-name="HP Spectre x360 13" product-price="50.00">
				...
				<li class="customRow mt20">
					<div class="col-sm-3 p0">
						<a class="addToCart" product-id="3" product-name="Dell XPS 15" product-price="100.00">
