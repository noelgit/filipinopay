<?php  
	...
	if($authorizationVal->Code){
		...
		if($tokenVal->access_token){ 
			...
			$requestorName = $_POST['fname']." ".$_POST['mname']." ".$_POST['lname'];

			$requestorFName = $_POST['fname'];
			$requestorMName = $_POST['mname'];
			$requestorLName = $_POST['lname'];

			$dataDoTransaction = array(
						   "merchant_code" => IPG_MERCHANT_CODE,
						   "merchant_ref_num" => $_POST['optn'],
						   "requestor_name" => $requestorName,
						   "requestor_fname" => $requestorFName,
						   "requestor_mname" => $requestorMName,
						   "requestor_lname" => $requestorLName,						   
