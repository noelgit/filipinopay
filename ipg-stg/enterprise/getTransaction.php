  			...
  			if($transaction){ 	
				$transactionHDR = $dbEnterprise->rawQuery("UPDATE tbl_transactions_hdr SET 
  				...
  				$transactionHDR = $dbEnterprise->rawQuery("
					...
					SELECT TRN, MERCHANT_CODE, MERCHANT_REF_NUM, SUCCESS_RETURN_URL, FAILED_RETURN_URL, REQUESTOR_NAME, REQUESTOR_FIRSTNAME, REQUESTOR_LASTNAME, REQUESTOR_MIDDLENAME, REQUESTOR_EMAIL_ADDRESS, REQUESTOR_MOBILE_NO, '".$getPaymentMethod."', '".$getPaymentEntity."', '2', '".$timeStamp."', CREATED_BY
